...
public class StartController {
    ...
    private void onOptionsClicked() {
        try {
            ...
            Parent settingsOverlay = loader.load();
    ...
    private void onAdventureClicked() {
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/org/example/plants_vs_zombies1/view/level_select.fxml"));
    ...
    private void onScoreboardClicked() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/org/example/plants_vs_zombies1/view/scoreboard.fxml"));
